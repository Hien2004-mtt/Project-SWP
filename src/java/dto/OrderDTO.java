...
public String toString(){
    ...
    public OrderDTO(int userID, Date orderDate, double totalAmount, String status, String shippingAddress, int paymentMethodID, int usePoints, String note, String name, String statusOrder, String email, String phone, String shipCode) {
        this.userID = userID;
        this.orderDate = orderDate;
