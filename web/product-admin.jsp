    ...
    <body>
        <div class="sidebar d-flex flex-column p-3">
         ...
         <a href=""><i class="bi bi-speedometer2"></i> Dashboard</a>
            ...
            <a href=""><i class="bi bi-people"></i> Accounts</a>
            <hr>
           <a href="t"><i class="bi bi-box-arrow-right"></i> Logout</a>
        </div>

        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4>Product Management</h4>
                <a href="" class="btn btn-success add-product-btn">
                    ...
                    <div class="col">
                        <div class="card product-card h-100 position-relative">
                            ...
                            <div class="card-body d-flex justify-content-between gap-2 pt-0">
                                ...
                                <form method="post" action="" class="w-50 m-0" onsubmit="return confirmDelete()">
                                    <input type="hidden" name="productID" value="${p.id}">
                                    <button type="submit" name="action" value="" class="btn btn-sm btn-outline-danger w-100">
